            ...
            <div className='w-full md:w-1/2  h-full p-6 pt-4 pb-8 flex flex-col gap-4' style={{background:background.secondary}}>
                ...
                <form className='w-[94%] md:w-[80%] h-full mx-auto mt-4 flex flex-col gap-4 justify-center'>
                    ...
                    <div className="flex flex-col gap-4">
                        <input className='formInput' type="email" name="" id="" style={{background:background.primary, fontSize:fontSize.base}} placeholder="Enter your email"/>
                        <input className='formInput' type="password" name="" id="" style={{background:background.primary, fontSize:fontSize.base}} placeholder="Enter your password"/>
